...
export default function Workflows() {
  ...
  const loadWorkflowsData = async () => {
    try {
      ...
      const workflowsData: Workflow[] = [
        {
          ...
          description:
            "Create emergency PO for SKU-332 due to critical stock level",
          ...
          auditTrail: [
            ...
            {
              id: "A2",
              action: "Accepted by Supply Team",
              user: "Sarah M.",
            ...
            },
            {
              ...
              details: "Supplier confirmed availability",
            },
          ],
          tasks: [
            {
              id: "T1",
              title: "Contact supplier for availability",
              completed: true,
              assignee: "Sarah M.",
              dueDate: "2024-01-16",
            },
            ...
            {
              id: "T3",
              title: "Arrange expedited shipping",
              completed: false,
              assignee: "Tom K.",
              dueDate: "2024-01-18",
            },
        ...
        },
        {
          ...
          description:
            "Investigate root cause of 90% increase in return rate for SKU-882",
          auditTrail: [
            {
              id: "A4",
              action: "Workflow Created",
            ...
            {
              id: "A5",
              action: "Accepted by Quality Team",
              user: "John D.",
              timestamp: "2024-01-14T10:30:00Z",
            },
            {
              id: "A6",
              action: "Return analysis started",
              user: "John D.",
              timestamp: "2024-01-15T14:00:00Z",
              details: "Initial data collection completed",
            },
          ],
          tasks: [
            {
              id: "T5",
              title: "Analyze return reasons",
              completed: true,
              assignee: "QA Team",
              dueDate: "2024-01-16",
            },
            {
              id: "T6",
              title: "Contact customers for feedback",
              completed: false,
              assignee: "CS Team",
              dueDate: "2024-01-18",
            },
            {
              id: "T7",
              title: "Review manufacturing batch",
              completed: false,
              assignee: "QA Team",
              dueDate: "2024-01-20",
            },
        ...
        },
        {
          ...
          auditTrail: [
            ...
            {
              id: "A8",
              action: "Assigned to Operations Manager",
              user: "Admin",
              timestamp: "2024-01-16T15:35:00Z",
              details: "SLA breach pattern detected",
            },
          ],
          tasks: [
            {
            ...
            {
              id: "T10",
              title: "Escalate to carrier management",
              completed: false,
        ...
        },
        {
          ...
          description:
            "Develop markdown strategy for SKU-1342 overstock situation",
          auditTrail: [
            {
              id: "A9",
              action: "Workflow Created",
            ...
            {
              id: "A10",
              action: "Accepted by Inventory Team",
              user: "Maria L.",
            ...
            },
            {
              ...
              details: "Inventory levels analyzed for SKU-1342",
            },
            {
              id: "A12",
              ...
              details: "Markdown strategy implemented successfully",
            },
          ],
          tasks: [
            {
            ...
            {
              id: "T13",
              title: "Calculate markdown scenarios",
              completed: true,
              assignee: "Finance",
              dueDate: "2024-01-13",
            },
      ...
      const openWorkflows = workflowsData.filter(
      ...
      const completedThisWeek = workflowsData.filter(
        (w) => w.completedDate && new Date(w.completedDate) > weekAgo,
      ).length;

      const avgCompletionTime = 4.2; // Mock average in days
      const completionRate =
        (workflowsData.filter((w) => w.status === "completed").length /
          totalWorkflows) *
        100;
  ...
  const generateFollowUpInsights = async (
    workflows: Workflow[],
    ...
    const idleWorkflows = workflows.filter(
      (w) =>
        w.status === "proposed" &&
        Date.now() - new Date(w.createdDate).getTime() >
          2 * 24 * 60 * 60 * 1000,
    );
    ...
    if (overdue.length > 0) {
      insights.push({
        ...
        description:
          "Multiple workflows have exceeded their SLA window and need immediate attention",
        ...
        rootCause:
          "Resource constraints and competing priorities causing workflow delays",
        evidenceTrail: [],
        confidence: 0.94,
          ...
          case "reassign":
            return {
              ...
              auditTrail: [
                ...
                {
                  ...newAuditEntry,
                  details: "Workflow reassigned to different team",
                },
              ],
            };
          default:
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Track issue resolution and workflow completion
            </p>
          </div>
        </div>
  ...
  return (
    <div className="p-6 space-y-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {metrics.openWorkflows.toLocaleString()}
                </p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-2xl font-bold">
                  {metrics.overdueWorkflows.toLocaleString()}
                </p>
          ...
          <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-2">
                  <Button onClick={createWorkflowFromModal}>
                    Create Workflow
                  </Button>
                  <Button
                    variant="outline"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  {workflow.tasks.slice(0, 3).map((task) => (
                    ...
                    >
                      <CheckCircle
                        className={`h-3 w-3 ${task.completed ? "text-success" : "text-muted-foreground"}`}
                      />
                      <span
                        className={
                          task.completed
              ...
              <div className="flex items-center space-x-2">
                {workflow.status === "proposed" && (
                  <>
                    <Button
                      size="sm"
                      onClick={() =>
                        handleWorkflowAction(workflow.id, "acknowledge")
                      }
                    >
                      Acknowledge
                    </Button>
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        handleWorkflowAction(workflow.id, "reassign")
                      }
                    >
                      Reassign
                    </Button>
                ...
                {workflow.status === "in_progress" && (
                  <>
                    <Button
                      size="sm"
                      onClick={() =>
                        handleWorkflowAction(workflow.id, "resolve")
                      }
                    >
                      Resolve
                    </Button>
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  onClick={() => setAuditTrailModal({ open: true, workflow })}
                >
                  View Audit Trail
      ...
      {/* Audit Trail Modal */}
      <Dialog
        open={auditTrailModal.open}
        onOpenChange={(open) =>
          setAuditTrailModal({ ...auditTrailModal, open })
        }
      >
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              Audit Trail - {auditTrailModal.workflow?.title}
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4">
            ...
            {(!auditTrailModal.workflow?.auditTrail ||
              auditTrailModal.workflow.auditTrail.length === 0) && (
              <div className="text-center py-8 text-muted-foreground">
